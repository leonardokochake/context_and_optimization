...
1. Open **[the workshop template](https://github.com//hackathon-red-panda-92/context-and-token-optimization/generate)**.
...
```bash
gh repo clone hackathon-red-panda-92/<your-repo-name>
